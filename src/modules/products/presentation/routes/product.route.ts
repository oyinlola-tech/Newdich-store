...
export function registerProductRoutes(app: FastifyInstance, container: Container): void {
  ...
  app.post('/admin/products', { preHandler: adminPermission(container, 'products.manage') }, controller.create.bind(controller));
  app.put('/admin/products/:id', { preHandler: adminPermission(container, 'products.manage') }, controller.update.bind(controller));
  app.delete('/admin/products/:id', { preHandler: adminPermission(container, 'products.manage') }, controller.delete.bind(controller));
}
