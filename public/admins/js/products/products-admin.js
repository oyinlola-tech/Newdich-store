import { fetchAdminProducts, createProduct, updateProduct, deleteProduct, fetchProductById } from '../../api/products/admin-products.js';
import { fetchAdminCategories } from '../../api/products/admin-categories.js';
import { checkAdminAuth } from '../main/admin.js';
import { formatCurrency } from '../main/format.js';
import { escapeHtml, escapeAttr, sanitizeUrl } from '../main/sanitize.js';
